...
const firebaseConfig = {
  ...
  // Убедитесь, что DOM загружен перед инициализацией канваса
  document.addEventListener('DOMContentLoaded', () => {
      ...
      if (!colorPicker) {
          console.error('Элемент color-picker не найден.');
      }
      ...
      function addPocket(element) {
          ...
          const pocketSize = document.getElementById('pocket-size') ? document.getElementById('pocket-size').value : 50;
